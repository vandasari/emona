...
with st.expander("Example 2 - Resizing the Gauge"):
    ...
    if _button_1:
        ...
        with st.echo(code_location="above"):
            streamviz.gauge(0.19, gSize="SML")
    ...
    if _button_2:
        ...
        with st.echo(code_location="above"):
            streamviz.gauge(0.61, gSize="MED")
    ...
    if _button_3:
        ...
        with st.echo(code_location="above"):
            streamviz.gauge(0.95, gSize="LRG")
    ...
    if _button_4:
        ...
        with st.echo(code_location="above"):
            streamviz.gauge(0.45, gSize="FULL")
...
with st.expander("Example 3 - Create a Gauge Title"):
    ...
    __YOUR_TITLE__ = st.text_input(
        "Gauge Title", key="8", placeholder="Enter a gauge title here..."
    )

    if __YOUR_TITLE__:

        with st.echo(code_location="above"):
            streamviz.gauge(0.85, gSize="FULL", gTitle=__YOUR_TITLE__)
...
with st.expander("Example 4 - Convert to Percentage"):
    ...
    with st.echo(code_location="above"):
        ...
        streamviz.gauge(
            0.85, gSize="LRG", gTitle="Plotly Stream Gauge", sFix=toggle_value
        )
...
with st.expander("Example 5 - Modify Gauge Type & Color"):
    ...
    with col1:
        ...
        gauge_value = st.number_input(
            "Gauge Value", value=0, key="11", min_value=0, max_value=100
        )
    ...
    with col2:
        ...
        low_range = st.number_input(
            "Low Gauge Range", value=29, key="13", min_value=0, max_value=100
        )
    ...
    with col3:
        ...
        mid_range = st.number_input(
            "Mid Gauge Range", value=69, key="15", min_value=0, max_value=100
        )
